...
case class Generators(hLines : Set[V], hRays : Set[V]) {
  ...
  override def equals(o : Any) : Boolean = {
    if (o.isInstanceOf[Generators]) {
      val oGenerators : Generators = o.asInstanceOf[Generators]
      return oGenerators.lines.equals(lines) && oGenerators.rays.equals(rays) && oGenerators.vertices.equals(vertices)
    }
    return false
  }
  ...
  override def hashCode() : Int = {
    val prime : Int = 13
    var hashCode = lines.hashCode()
    hashCode = hashCode * prime + rays.hashCode()
    hashCode = hashCode * prime + vertices.hashCode()
    return hashCode
  }
}
